...
#         raise ValueError(
#             f"Invalid config format. Expected dictionary, got {type(cfg).__name__}: {cfg}"
#         )
#
#     report_cfg = cfg.get("report", {})
#
#     report_title = report_cfg.get("title", "Automation Test Report")
#     report_env = report_cfg.get("environment", "QA")
#     primary_color = report_cfg.get("primary_color", "#4CAF50")
#
#     return report_title, report_env, primary_color
