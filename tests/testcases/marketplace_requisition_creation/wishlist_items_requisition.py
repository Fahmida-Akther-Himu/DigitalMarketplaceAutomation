...
from pages.digital_marketplace.public_side_framework_agreement_list import PublicSideFrameAgreementListPage
...
def test_1_product_added_to_user_wishlist(page, new_tab):
    """
    Test Case 7:
    ...
    """
    print("Test 1: Marketplace requisition is available on the Active Requisition List...")
    ...
    home_page.get_full_page_screenshot('1. Welcome to Digital Marketplace')
    home_page.wait_for_timeout(2000)
    home_page.go_to_all_framework_agreements_list()

    public_framework_agreement_list = PublicSideFrameAgreementListPage(page)
    public_framework_agreement_list.search_agreement(agreement_number=whitelisted_agreement_number)
    public_framework_agreement_list.agreement_view_hyperlink.click()

    public_framework_agreement_list.product_links.nth(0).click()
    public_framework_agreement_list.product_add_to_wishlist()
...
#
#     create_requisition_page.get_wishlist_button.click()
